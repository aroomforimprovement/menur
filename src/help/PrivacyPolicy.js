...
export const PrivacyPolicy = () => {
    return(
        <div className='privacy-policy p-5'>
            ...
            <li>
            <p><strong>Website</strong> refers to Menur, accessible from <a href="https://menur-ui.herokuapp.com" rel="external nofollow noopener" target="_blank">https://menur-ui.herokuapp.com</a></p>
            </li>
            <li>
